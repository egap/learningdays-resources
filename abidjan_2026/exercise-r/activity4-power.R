...
# C'est l'analyse de puissance statistique.
# Dans cet exercice, nous explorerons comment la puissance change avec les entrées clés pour avoir une idée de ce qui affecte la puissance et aussi ce que nous devons savoir avant de commencer l'analyse de puissance statistique.
...
# la puissance statistique augmente-t-elle si vous augmentez la taille d'effet attendue ?
...
# Doubler la taille de l'effet. Question: quelle est la puissance pour un échantillon de 100? de 500? Ces chiffres ont-ils augmenté ou diminué?
...
# Doubler l'écart type du résultat. Question: quelle est la puissance pour un échantillon de 100? de 500? Ces chiffres ont-ils augmenté ou diminué?
...
# quelle est l'effet minimum détectable ?
...
# Jetez un œil au graphique et trouvez où la courbe bleue croise la ligne rouge. Ce point est la plus petite taille d'échantillon (axe x) où il y a au moins une puissance de 80 % (axe y), c'est le seuil que nous avons défini dans les options.
...
# Question : quelle est l'effet minimum détectable pour N = 500 ?
