...
- **Research design form** (reference):
  [English version](0_research_design_form_en.html)

- **Download the fill-in Word document** for group work:
  [English (.docx)](0_research_design_form_blank_en.docx){.docx-link}
...
- **Formulaire de design de recherche** (référence) :
  [version française](0_research_design_form_fr.html)

- **Téléchargez le document Word à compléter** pour le travail en groupe :
  [Français (.docx)](0_research_design_form_blank_fr.docx){.docx-link}
