...
- **Inquiry** (*question*) : une question formulée à partir du modèle
- **Data strategy** (*stratégie de données*) : échantillonnage, assignation, mesure
- **Answer strategy** (*stratégie de réponse*) : comment on résume les données
...
Le **redesign** modifie les stratégies de données et de réponse pour voir comment les diagnosandes évoluent :
...
- I : Définir une estimande : l'**effet moyen dans l'échantillon**
...
Une exécution produit les données, les **estimandes**, les **estimations** et des statistiques auxiliaires.
...
Après de nombreuses simulations, mesurez le **biais** : l'écart moyen entre estimande et estimation.
