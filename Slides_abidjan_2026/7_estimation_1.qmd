...
library(tidyverse)
library(patchwork)
opts_chunk$set(warning = FALSE, message = FALSE, out.width = "72%", fig.align = "center")
```
...
## New example: block randomization | *Nouvel exemple : randomisation par blocs*
...
What answer strategy should we select?

:::
::: {.column .lang-fr width="50%"}

Quelle stratégie de réponse devons-nous choisir ?
