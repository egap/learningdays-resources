...
- One number in **black** on white background
- One number in **white** on black background
- On the **reverse**, there may or may not be a **symbol or text**
...
- Au **dos**, il peut y avoir ou non un **symbole ou du texte**
...
C'est votre estimande — la quantité que vous voulez estimer.
...
Each card can give two possible anwers:
...
You choose the assignment to white or balck: 

$X=1$: read white or $X=1$: read black.
...
$X=1$ : lire le blanc ou $X=1$ : lire le noir.
...
5. Compute:
   ...
   - figure out what the **right** answer is and record whether you got the right answer or not
...
5. Calculez :
   ...
   - déterminez la **bonne** réponse et notez si vous avez trouvé la bonne réponse ou non
...
Tip: difference-in-means compares average $Y$ when $Z=1$ vs $Z=0$.

:::
::: {.column .lang-fr width="50%"}

Astuce : la différence de moyennes compare la moyenne de $Y$ quand $Z=1$ vs $Z=0$.
...
- Will you change **how** you assign $Z$?
- Will you change **how** you analyze the data?

Then repeat Steps 1–5 ten times.

Plot histograms of your **estimates**, **standard errors**, and **$p$-values** across the 10 runs.
...
- Allez-vous changer **comment** vous assignez $Z$ ?
- Allez-vous changer **comment** vous analysez les données ?

Puis répétez les étapes 1–5 dix fois.

Tracez des histogrammes de vos **estimations**, **erreurs-types** et **$p$-valeurs** sur les 10 répétitions.
...
2. Using your 10 runs, assess:
   ...
   - **Coverage** — did confidence intervals contain the truth?
...
2. À partir de vos 10 répétitions, évaluez :
   ...
   - **Couverture** — les intervalles de confiance contiennent-ils la vérité ?
...
- What assignment rule did you use for $Z$? Why?
...
- Quelle règle d'assignation avez-vous utilisée pour $Z$ ? Pourquoi ?
...
- What is the difference between **design** (how you assign $Z$) and **analysis** (how you estimate)?
...
- Quelle est la différence entre **conception** (comment vous assignez $Z$) et **analyse** (comment vous estimez) ?
