...
Tengan en cuenta que necesitamos *conocer* las resultados potenciales y la
...
En la vida real sólo podemos observar una realización de las resultados potenciales. Recuerden que cada unidad tiene su propio efecto bajo el tratamiento.
...
```{r dd1, echo=TRUE}
# # Seleccionar las resultados potenciales bajo control y tratamiento
...
- Cuando el tamaño del conglomerado está relacionado con las resultados potenciales, el estimador habitual de diferencias de medias está sesgado. <https://declaredesign.org/blog/bias-cluster-randomized-trials.html>
...
x2=rnorm(N))
# declarar las resultados potenciales
...
# la pooblación, las resultados potenciales,
...
cuando se visita o no es un atributo fijo, como una resultado potencial).
 ...
 - $Y$: variable de interés ($y_ {i, Z}$ o $y_ {i, Z_i = 1}$ para la resultado potencial de
