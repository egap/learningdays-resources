...
## Puntos clave sobre la estimación V
 ...
 -  **Analizar conforme se aleatoriza** en cuanto a la estimación esto significa que (1) nuestros errores estándar deben medir la variabilidad de la aleatorización y (2) y el objetivo de nuestros estimadores deben ser estimandos definidos en términos de salidas potenciales.
...
## ¿Cómo podemos aprender sobre los efectos causales utilizando los datos observados?
 ...
 1. Recordemos que podemos **probar hipótesis** sobre las dos salidas potenciales $\{Y_{i}(T_ {i} = 1), Y_{i} (T_{i} = 0)\}$.
...
Tengan en cuenta que necesitamos *conocer* las salidas potenciales y la
...
En la vida real sólo podemos observar una realización de las salidas potenciales. Recuerden que cada unidad tiene su propio efecto bajo el tratamiento.
...
```{r dd1, echo=TRUE}
# # Seleccionar las salidas potenciales bajo control y tratamiento
...
# Especificar variable de interés y asignación al tratamiento
...
# la pooblación, las salidas potenciales,
...
Pero esta comparación está asociada con $x$: una simple $\bar{Y} | D = 1 - \bar {Y} | D = 0$ comparación nos deja ver las diferencias en la variable de interés ocasianadas por $x$ además de
