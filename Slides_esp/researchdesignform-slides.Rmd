...
- El pre-registro es incluir el diseño de investigación e hipótesis en un repositorio de acceso público. EGAP aloja uno que se puede usar de forma gratuita (actualmente en OSF.io utilizando el formulario de registro EGAP).
