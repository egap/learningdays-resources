...
- La calidad de un diseño de investigación se puede evaluar por los resultados que  produce, los cuales pueden utilizarse para orientar las políticas y contribuir a la ciencia:  
    ...
    - Un excelente diseño de investigación produce resultados que nos guían claramente en ciertas direcciones que son relevantes. **(Personally, I don't think this sentence is clear in English or Spanish. What kind of directions are we talking about? Directions of inquiry?)
...
- La investigación que está centrada en conocer el efecto causal de $X$ en $Y$ requiere pensar en un modelo del mundo: *cómo* la intervención $X$ podría afectar a una variable de interés $Y$, y *por qué* y *qué tan grande* podría ser el efecto. Esto nos ayuda a pensar en cómo una intervención diferente o que esté dirigida a diferentes destinatarios podría producir resultados diferentes.
...
- Desde este punto en adelante, usaremos $T$ para el tratamiento o el efecto en el que estamos interesados. Usaremos $X$ para referirnos a las variables de fondo. **(I am not familiar with "variables de fondo" term, I would suggest "variables extrañas.") 
...
Una campaña de salubridad en la que un voluntario visita un hogar para hablar con una familia durante 15 minutos para dar información sobre temas de salud.
  ...
  - Si su pregunta se centra en el efecto de las visitas, entonces se necesita un grupo de control que no reciba visitas. Pero este diseño no servirá para responder preguntas específicas sobre el contenido de la información (las visitas y la información están combinadas en un sólo tratamiento).
...
- No se puede concluir que han estimado solamente el efecto de la información comunicada.
...
# El Formulario de Diseño de Investigación de EGAP

## El Formulario de Diseño de Investigación de EGAP

- Creamos un [Formulario para el Diseño de Investigación](https://egap.github.io/learningdays-gui/Exercises/design-form.Rmd) que provee de una estructura para desarrollar un buen diseño de investigación.
...
- ¿Cuál es la variable de interés principal?

- ¿Cómo se medirá?

- ¿Qué datos se necesitan? ¿A qué nivel se pueden medir los datos?

- ¿Qué ideas tienen sobre la variable de interés previo a la recolección de datos (priors)?  Éstas pueden basarse en estudios previos o suposiciones bien fundamentadas.
...
- Un modelo de cómo pensamos que el mundo funciona incluye:
  ...
  - $T$s y $X$s (tratamientos o variables causales centrales como intervenciones de políticas y otras variables de fondo (extrañas?))
...
- No todas las preguntas que queremos hacer tienen respuesta.
  ...
  - Y la gama de indagaciones que podemos hacer es limitada: ¿cuánto podemos aprender de una cantidad que resume los datos, como es el efecto de tratamiento promedio (ATE)?
...
- El pre-registro es incluir su diseño de investigación e hipótesis en un repositorio de acceso público. EGAP aloja uno que puede usar de forma gratuita (actualmente en OSF.io utilizando el formulario de registro EGAP).
