...
Esto es algo que podemos calcular con datos observados. Llamamos a un cálculo una "estimación" porque tenemos la esperanza de que este cálculo con cantidades observadas nos diga algo sobre algo no observable como: $\bar{\tau}=\bar{Y}_i(1) - \bar{Y}_i(0)$.
