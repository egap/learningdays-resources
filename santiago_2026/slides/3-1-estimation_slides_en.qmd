...
In general, simply "controlling for" produces a biased estimator of the ATE **or** ITT estimand. For example, @freedman2008rae shows this bias and @lin_agnostic_2013 shows how to reduce it and, importantly, that this bias tends to be small as the sample size increases.
