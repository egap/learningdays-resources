...
```{r sim_plot, out.width=".75\\textwidth", fig.width=9, fig.height=3, warning=FALSE,message=FALSE}
...
How should we interpret this plot?
```{r sim_plot2, warning=FALSE, out.width=".85\\textwidth", fig.width=10, fig.height=4, message=FALSE,warning=FALSE, echo=FALSE,tidy=FALSE}
...
```{r sim_plot_clus, warning=FALSE, out.width=".9\\textwidth", fig.width=10, fig.height=3.8}
...
```{r sim_plot_bin_print, out.width=".85\\textwidth", fig.width=10, fig.height=4, warning=FALSE,message=FALSE, echo=FALSE, cache=FALSE, tidy=FALSE}
print(sim_plot_bin)
```
