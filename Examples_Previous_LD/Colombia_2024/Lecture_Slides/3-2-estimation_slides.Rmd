...
```{r sim_plot_bin_print, out.width=".95\\textwidth",warning=FALSE,message=FALSE, echo=FALSE, cache=FALSE, tidy=FALSE}
print(sim_plot_bin)
```
...
Lost `DiM` y `LM` con pesos de tamaño de bloque son, en teoria, sin sesgo. Y los con `Precision Weights` deben, en teoria, tener mas sesgo pero mas eficiencia.
