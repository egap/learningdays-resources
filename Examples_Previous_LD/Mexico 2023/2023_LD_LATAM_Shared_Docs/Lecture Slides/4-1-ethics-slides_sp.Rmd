...
- Esto no es tan fácil.
  ...
  - Que una variable de resultado sea buena o mala puede depender de la perspectiva de cada uno, lo que hace que el cálculo riesgo-beneficio sea a veces difícil de evaluar.
...
- Una Junta de Evaluación Institucional (IRB) u otro Comité de Ética de Investigación puede
  revisar sus planes de interacción directa con seres humanos antes del levantamiento de datos.
...
- Algunas investigaciones infames que abusaron de sus sujetos a través del siglo XX:
    ...
    - El Estudio Tuskegee (que ha tenido efectos de muy largo alcance en la investigación con participantes afroamericanos en Estados Unidos)
    - El estudio Milgram
...
- **Por definición** los investigadores deben obtener primero el consentimiento informado de los sujetos de estudio. Esto requiere que los sujetos tengan:

  - Capacidad para consentir la participación en el estudio
    
  - Libertad de acción para decidir si se participa o no
...
- El anonimato debe usarse **por definición** (con toda la información de identificación de los sujetos destruida después del estudio), ya que proporciona la mayor protección a dichos sujetos.
...
- El instrumento de levantamiento de datos (cuestionario de encuesta, etc.).

- Declaración de los beneficios y riesgos previstos, incluída la forma en que se difundirán los resultados.
...
- Prepárese para explicar su investigación un poco más. Tal vez pueda planear una reunión con un café para contextualizar la investigación en ciencias sociales a un miembro de un comité de revisión médica.

## Asegúrese de reservar tiempo suficiente para el comité de revisión de ética.

- Reserve tiempo suficiente para ir y venir al comité de revisión de ética en caso de que haya preguntas sobre su solicitud y tenga que hacer cambios en su estudio.
...
- No podrá publicar en revistas académicas artículos con datos recogidos de sujetos humanos sin la aprobación o exención del comité de revisión ética.
...
- Humildad: Los propios investigadores pueden no ser conscientes de posibles daños.  ¿Cómo podemos ser conscientes de ellos?
  ...
  - Las asociaciones locales no proveen una solución automática.
...
- Consentimiento informado. ¿Cómo? ¿De quién? ¿Quiénes son las partes interesadas?
  ...
  - ¿Cómo podemos enumerar a todas las personas que pueden verse afectadas por una intervención? ¿Debemos hacerlo? ¿Dónde paramos con el consentimiento?
