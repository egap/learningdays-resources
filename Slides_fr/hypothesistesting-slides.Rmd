...
- Une randomisation (ou un design) + une hypothèse + une fonction de test statistique $\rightarrow$ distributions de probabilité représentant l'hypothèse (distributions de référence)
