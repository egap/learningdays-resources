...
- Une randomisation (ou un design) + une hypothèse + une function de statistique de test $\rightarrow$ distributions de probabilité représentant l'hypothèse (distributions de référence)
