...
- TODO Randomization (or Design) + a Hypothesis + a Test Statistic Function $\rightarrow$ distributions de probabilité représentant l'hypothèse (distributions de référence)
...
## Ingrédients d'un test d'hypothèse
 ...
 - Une **hypothèse** est un énoncé concernant une relation entre TODO potential outcomes.
