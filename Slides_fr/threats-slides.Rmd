...
- Lorsque les données sur les résultats sont manquantes, nous pouvons parfois **déterminer** nos estimations de l'effet de traitement.
...
## Non-conformité
  ...
  - L'effet de recevoir le traitement est souvent appelé "effet de traitement moyen local" (LATE) ou "effet causal moyen conforme" (CACE).
