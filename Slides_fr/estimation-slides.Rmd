...
```{r}
kableExtra::kable(reshape_diagnosis(diagnosis1, select = c("Estimateur", "Biais", "REQM", "Estimateur de l'erreur type", "Moyenne de l'erreur type", "Puissance"))[,-c(1,2,4,5,6)])
```
