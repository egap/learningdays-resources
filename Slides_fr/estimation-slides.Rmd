...
- **Pas un exemple 1 :** Les quartiers sont choisis pour l'étude. Dans chaque quartier, environ la moitié des personnes sont assignées au traitement et l'autre moitié au contrôle. (De quel type d'étude s'agit-il ? Ce n'est pas une étude randomisée en grappe.)
...
## Résumé de l'estimation et des tests dans les essais aléatoires en grappe
 ...
 - Les essais aléatoires en grappe posent des problèmes particuliers pour les approches standard d'estimation et de test.
