...
## Comment en savoir plus sur les effets causaux à partir des données observées ?
 ...
 2. Nous pouvons **définir les estimandes** en termes de $\{ Y_{i}(T_{i}=1), Y_{i}(T_{i}=0) \}$ ou $\tau_i$, **développer des estimateurs** pour ces estimandes,
    puis calculer les valeurs et les erreurs type pour ces estimateurs.
...
Et nous pourrions *définir* l'erreur type de l'estimateur en faisant la moyenne intra-bloc des erreurs type (si nos blocs sont suffisamment grands) :
