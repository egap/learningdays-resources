...
- Avoir moins de grappes nuit à votre capacité à détecter les effets du traitement et à conduire à des $p$-valeurs, des intervalles de confiance (ou même des estimations) trompeurs.
...
- Vous pouvez avoir des grappes dans des blocs.
   ...
   - Exemple : îlot = quartier, grappe = communautés, unités = individus. Vous mesurez les résultats au niveau individuel.
