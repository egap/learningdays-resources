...
simple.ra <- rbinom(n = N,taille = 1, prob = .5)
...
traitement <- simple_ra(N = N, # taille totale de l'échantillon
...
- Blocks that represent a substantively meaningful subgroup can help you to
  learn about how effects might differ by subgroup.
    ...
    - Especially useful when you have a rare group --- by chance you might get    very few of them in treatment or control even under random assignment (or
