...
- Vérifiez l'équilibre global avec un test du khi2 en utilisant `xBalance` dans le package `RItools` (@hansen:bowers:2008) (inférence de randomisation d'un grand échantillon):
