...
- Exemple : Si vous avez 6 unités et que vous lancez une pièce équitable pour chacune, vous avez environ 3% de chances d'assigner **toutes** unités au traitement ou d'assigner **toutes** unités au contrôle.
