...
- Nous créons des blocs d'unités et randomisons séparément dans chaque bloc. Nous faisons des mini-expériences dans chaque bloc.
   ...
   - Exemple : bloc = quartier, unités = communautés. Nous randomisons le traitement au niveau communautaire **au sein du quartier** et mesurons également les résultats au niveau communautaire.
...
- Vous pouvez avoir des grappes dans des blocs.
   ...
   - Exemple : bloc = quartier, grappe = communautés, unités = individus. Vous mesurez les résultats au niveau individuel.
...
- Pour les designs plus compliqués, vous pourriez trouver `DeclareDesign` utile. (<https://declaredesign.org>)
...
- Le design factoriel permet de tester plus qu'un traitement.
...
Nous pourrions nous concentrer sur un estimande comme $\mathbb{E}[Y(X_1=1, X_2=1)]-\mathbb{E}[Y(X_1=0, X_2=0)]$.
...
- Violations des hypothèses clés (effets de débordement ; violation de la deuxième hypothèse clé de l'[inférence causale](causalinference.html)).
