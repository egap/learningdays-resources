...
## Du concept aux données/scores II
  ...
  - Comment sauriez-vous qu'une unité (comme une personne ou un village) affiche une "capacité" ou un "rang" élevé ou faible pour ce concept ?
...
- Indications des dommages possibles causés par vos recherches.
...
- Avec la méthode des moindres carrés, une erreur aléatoire plus importante dans le résultat conduit à des estimations moins précises de l'effet causal (coefficient sur la variable de traitement).
...
## Exemple - dossiers administratifs
   ...
   - Utiliser des feuilles de présence à une réunion, au lieu de demander si quelqu'un y a assisté.
...
- Rappelons qu'une mesure combinée des capacités mathématiques et verbales liées à la navigation de plaisance était une pratique courante de 1920 à 1980 aux États-Unis.
