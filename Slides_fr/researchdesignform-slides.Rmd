...
- Planifiez votre analyse, énoncez et justifiez les hypothèses spécifiques et enregistrer-le pour que d'autres personnes puissent le comprendre.
...
- Quel type de stratégie de randomisation utiliserez-vous ? Exemples : simple, complète, par bloc, en grappe, factorielle, à deux niveaux, par étape, etc.
...
- Pour voir plus (https://declaredesign.org/getting-started.html)
