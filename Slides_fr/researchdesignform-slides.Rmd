...
- Quels sont les challenges logistiques ? Des challenges particuliers pour les unités de contrôle ?
...
- Même les personnes qui ne sont pas confrontées à ce probleme prennent de nombreuses décisions lorsqu'elles analysent des données : traitement des valeurs manquantes et des observations en double, création d'échelles, etc. Et les répercutions de ces choix peuvent être conséquentes.
