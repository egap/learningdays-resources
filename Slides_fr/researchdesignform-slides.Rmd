...
Une campagne où quelqu'un visite une maison pour partager avec une famille pendant 15 minutes des informations sur la santé.
...
- Vous ne pourrez pas conclure que vous avez estimé l'effet de la seule information.
     ...
     - Cela peut convenir à certaines fins de politiques publiques : peut-être que la question porte sur les visites en tant qu'ensemble implicite de traitements.
...
- Nous avons développé [un formulaire de design de recherche EGAP](https://egap.github.io/learningdays-gui/Exercises/design-form.Rmd) that helps provide structure for a good research design
...
- Quelle est votre estimation? (e.g. effet de traitement moyen, effet causal moyen pour ceux qui se conforment au traitement, etc.)
