...
- Quel type de stratégie de randomisation utiliserez-vous ? Exemples : simple, complète, par bloc, en grappe (cluster), factorielle, à deux niveaux, par étape, etc.
...
- Anticiper ou faire face aux difficultés de publication : les manuscrits avec des résultats non concluants ne sont jamais soumis pour examen ou sont mis au placard après plusieurs refus.
