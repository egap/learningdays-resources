...
-  Si non, nous pouvons encore cibler l'ITT avec les autres hypothèses clés standards.
...
-   L'ITT peut être un compromis, mais il peut s'agir de l'estimand qui vous intéresse.  La politique peut modifier directement $Z$, mais pas $D$.  L'ITT (effet de $Z$ sur $Y$) peut donc être plus important.
