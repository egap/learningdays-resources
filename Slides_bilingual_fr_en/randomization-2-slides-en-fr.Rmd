...
Graeme souhaite étudier l'impact de la consommation de café (traitement) sur le niveau d'enthousiasme des participants aux LD lors de la première conférence de la journée.
Il ne peut cependant pas forcer les participants LD à boire du café, car certains préfèrent le thé.
Il reçoit 3 conseils de différents instructeurs LD sur la façon d'intégrer cela dans sa conception.
...
B. Lauren dit de randomiser les *encouragements* à boire du café.

C. Natalia recommande la randomisation par bloc en fonction de la nationalité et du fait qu'un participant aux LD aime ou non le café.
...
Yabo veut étudier l'impact de la fourniture d'informations sur le droit de vote aux citoyens sur la participation électorale.
Elle veut randomiser au niveau des citoyens individuels au sein d'un village. Cependant, le contexte dans lequel elle travaille comporte de petits villages où les gens interagissent fréquemment.
Elle craint que cela ne menace la validité interne de son étude. Elle reçoit 3 conseils de différents instructeurs aux LD sur la façon d'anticiper de telles menaces dans sa conception. Quel est le meilleur conseil ?

A. Christelle conseille d'effectuer son enquête de référence en personne plutôt qu'au téléphone, afin de s'assurer que davantage de personnes répondent.
