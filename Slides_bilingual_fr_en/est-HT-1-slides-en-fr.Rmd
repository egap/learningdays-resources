...
::: {.cols data-latex=""}
::: {.col data-latex="{0.48\\textwidth}"}
-   $p$-value: The probability of seeing a test statistic as large (in
    absolute value) as or larger than the test statistic calculated from
...
::: {.col data-latex="{0.48\\textwidth}"}
-   $p$-valeur : La probabilité de voir une statistique de test aussi
    grande (en valeur absolue) ou plus grande que la statistique de test
