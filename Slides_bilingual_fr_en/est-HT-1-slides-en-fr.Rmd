...
::: {.cols data-latex=""}
::: {.col data-latex="{0.48\\textwidth}"}
-   You can use linear regression with block fixed effects, which
    facilitates hypothesis testing, applying weights to each observation.
...
::: {.col data-latex="{0.48\\textwidth}"}
-   Nous pouvons ensuite utiliser la régression linéaire avec des effets fixes en bloc, ce qui facilite le test des hypothèses, en appliquant des pondérations à chaque observation.
