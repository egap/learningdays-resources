...
```{r}
# library(estimatr)
# difference_in_means(Y ~ treatment, blocks = Gender_Language)

```

## Estimator 2: Linear Regression with Block Fixed Effects \| *Estimateur 2 : La régression linéaire avec effets fixes par bloc*

$$Y_{ij} = \beta_0 + \beta_1 Z_{ij} + \gamma_A BlockA_{ij} + \gamma_B BlockB_{ij} + ... + e_{ij}$$
...
```{r, echo=TRUE}
# summary(lm(Y ~ treatment + as.factor(blockvariable)))
