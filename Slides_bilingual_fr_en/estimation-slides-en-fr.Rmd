...
<!-- - Linear regression with $Y \sim Z + X_c + Z:X_c$ (take Z) -->
...
2.  Is assignment clustered? $\rightarrow$ cluster-robust s.e. at level where assignment took place

3.  Is the inquiry about a population from which you randomly sampled? Advice above may not apply.
