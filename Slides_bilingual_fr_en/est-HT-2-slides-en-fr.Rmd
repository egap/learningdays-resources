...
$$Y_{ic} = \hat{\beta_0} + \hat{\beta_1} Z_{c} + \hat{\beta_2} X_{ic} +e_{ic}$$
...
-   Régression avec une variable indicatrice pour chacun des deux bras
    ...
    -   $Z_{Ai}=1$ si unité $i$ a traitement A, sinon 0 
    
    -   $Z_{Bi}=1$ si unité $i$ a traitement B, sinon 0 
...
# M <- difference_in_means(Y ~ treatment, 
#         condition1="T1", 
#         condition2="T2")
...
\begin{table}[]
\begin{tabular}{llp{1in}p{1in}}
&  & \multicolumn{2}{c}{\textbf{$Z_2$}}  \\
&  & \multicolumn{1}{c}{1} & \multicolumn{1}{c}{0}\\ \cline{3-4} 
\multicolumn{1}{c}{\multirow{2}{*}{\textbf{$Z_1$}}} & \multicolumn{1}{l|}{1} & \multicolumn{1}{p{1in}|}{Both $Z_1$ and $Z_2$} & \multicolumn{1}{p{1in}|}{$Z_2$ only} \\
&\multicolumn{1}{l|}{}&\multicolumn{1}{p{1in}|}{}&\multicolumn{1}{p{1in}|}{} \\
\cline{3-4} 
\multicolumn{1}{c}{} & \multicolumn{1}{l|}{0} & \multicolumn{1}{l|}{$Z_1$ only}           & \multicolumn{1}{l|}{Neither}    \\
&\multicolumn{1}{l|}{}&\multicolumn{1}{p{1in}|}{}&\multicolumn{1}{p{1in}|}{} \\
\cline{3-4} 
\end{tabular}
\end{table}
...
-   Estimand \| Paramètre: $E[Y(Z_1=1)-Y(Z_1=0) | Z_2=0]$
...
$$\hat{Y} = 0.151 - 0.249 Therapy - 0.079 Cash - 0.308 Therapy*Cash $$
...
Therapy only: $\hat{Y} = 0.151 - 0.249$

Cash only: $\hat{Y} = 0.151 - 0.079$

Therapy and Cash: $\hat{Y} = 0.151 - 0.249 - 0.079 - 0.308$

\bigskip

$\widehat{ATE}$ of Cash conditional on No Therapy = $0.151-0.079-0.151 = -0.079$

$\widehat{ATE}$ of Cash conditional on Therapy = $0.151 - 0.249 - 0.079 - 0.308 - (0.151 - 0.249) = -0.079-0.308 = - 0.387$
