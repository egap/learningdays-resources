...
title: "| Estimation and Hypothesis Testing 2 | \n| *Les estimateurs et les tests
  d'hypothèses 2*\n"
author: "Alyssa Heinze and/et Isabelle Becho-N'Dri"
...
-   Regression with an indicator variable for each of the two treatment
    ...
    -   $Z_{Ai}=1$ if unit $i$ has treatment A, 0 otherwise
    
    -   $Z_{Bi}=1$ if unit $i$ has treatment B, 0 otherwise
...
$$Y_i = \hat{\beta_0} + \hat{\beta_1} Z_{1i} + \hat{\beta_2} Z_{2i} + \hat{\beta_3} Z_{1i}*Z_{2i} + \hat{\beta_4} X_i + e_i$$
