...
&  & \multicolumn{2}{c}{\textbf{$Z_2$}}  \\
&  & \multicolumn{1}{c}{1} & \multicolumn{1}{c}{0}\\ \cline{3-4} 
\multicolumn{1}{c}{\multirow{2}{*}{\textbf{$Z_1$}}} & \multicolumn{1}{l|}{1} & \multicolumn{1}{p{1.2in}|}{Both $Z_1$ and $Z_2$} & \multicolumn{1}{p{1.2in}|}{\cellcolor[HTML]{C0C0C0}\color{red} $Z_1$ only} \\
&\multicolumn{1}{l|}{}&\multicolumn{1}{p{1.2in}|}{}&\multicolumn{1}{p{1.2in}|}{\cellcolor[HTML]{C0C0C0}} \\
\cline{3-4} 
\multicolumn{1}{c}{} & \multicolumn{1}{l|}{0} & \multicolumn{1}{l|}{$Z_2$ only}           & \multicolumn{1}{l|}{\cellcolor[HTML]{C0C0C0}\color{blue}Neither}    \\
&\multicolumn{1}{l|}{}&\multicolumn{1}{p{1.2in}|}{}&\multicolumn{1}{p{1.2in}|}{\cellcolor[HTML]{C0C0C0}} \\
\cline{3-4} 
\end{tabular}
\end{table}
