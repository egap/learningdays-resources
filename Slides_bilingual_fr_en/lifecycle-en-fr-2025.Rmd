...
Start with the research design form.
...
Commencez avec la formulaire de conceptualisation de recherche.
...
- And it alerts others that your study exists $\rightarrow$ reduces the "file drawer problem"
...
- Elle previent les autres de l'existence de votre étude $\rightarrow$ réduit le "problème des tiroirs".
...
- Project budgets
- In-kind donations (equipment, time, etc.)
- Research grants
